function Navbar({handleClick}) {
  return (
      <div className="h-[300px] image">
        <div className=' cite-container pt-[65px] text-white flex items-center justify-between'>
        <h1 className="tracking-[15px] text-[40px] font-semibold  font-jose">TODO</h1>
        <div className="">
